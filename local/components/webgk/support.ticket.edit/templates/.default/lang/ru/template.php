...
$MESS ['SUP_TICKET_TIME'] = "Затраченное время (ч.)";
$MESS ['SUP_BACK'] = "Назад к списку обращений";
$MESS ['SUP_ERROR'] = "Произошла ошибка при загрузке данных!";
$MESS ['SUP_ADMIN'] = "Администратор техподдержки";
$MESS ['SUP_COMMENT_REQUIRED'] = 'При установке данного статуса необходимо заполнить поле "Сообщение"!';
$MESS ['SUP_TICKET_IN_PAYMENT'] = 'УЧАСТВУЕТ В ОПЛАТЕ';
$MESS ['SUP_TICKET_TEST'] = 'Тестирование';
$MESS ['SUP_TICKET_NEED_TEST'] = 'Требуется тестирование';
$MESS ['SUP_TICKET_TEST_PASSED'] = 'Тестирование пройдено';
$MESS ['SUP_TITLE'] = 'Заголовок';
?>