...
<div id="slider">
    ...
    <h1>
        <?$APPLICATION->IncludeFile("/include/1c_bitrix.php",Array(),Array("MODE"=>"html"));?>
    </h1>
    <div id="line"></div>
...
<div class="bitrix_bg">
    <div id="content1">
        ...
        <div class="lozung"><?$APPLICATION->IncludeFile("/include/bistro_prosto.php",Array(),Array("MODE"=>"html"));?></div>
        ...
        <table  class="times"> 
            <tr>
                <td><div class="menu_line1"></div></td>
                <td><div class="menu_line3"></div></td>
                <td><div class="menu_line4"></div></td>
                <td><div class="menu_line5"></div></td>
                <td><div class="menu_line2"></div></td>
            </tr>

            <tr>
                <td><b><a href=""><?$APPLICATION->IncludeFile("/include/corp_site.php",Array(),Array("MODE"=>"html"));?></a></b></td>
                <td><b><a href=""><?$APPLICATION->IncludeFile("/include/inet_magaz.php",Array(),Array("MODE"=>"html"));?></a></b></td>
                <td><b><a href=""><?$APPLICATION->IncludeFile("/include/info_portal.php",Array(),Array("MODE"=>"html"));?></a></b></td>
                <td><b><a href=""><?$APPLICATION->IncludeFile("/include/socio_site.php",Array(),Array("MODE"=>"html"));?></a></b></td>
                <td><b><a href=""><?$APPLICATION->IncludeFile("/include/web_project.php",Array(),Array("MODE"=>"html"));?></a></b></td>
            </tr>
