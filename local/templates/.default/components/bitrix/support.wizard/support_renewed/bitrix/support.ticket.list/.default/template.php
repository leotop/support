    ...
    $APPLICATION->IncludeComponent(
        ...
        array(
            ...
            "HEADERS"=>array(
                ...
                array("id"=>"RESPONSIBLE_HTML_NAME_S", "name"=>GetMessage('SUP_RESPONSIBLE'), "sort"=>"s_responsible_html_name_s", "default"=>true),
                array("id"=>"MESSAGES", "name"=>GetMessage('SUP_MESSAGES'),  "default"=>true),
                array("id"=>"STATUS_NAME", "name"=>GetMessage('SUP_STATUS'), "default"=>true),
                array("id"=>"OWNER_HTML_NAME_S", "name"=>"Кем создан", "default"=>true),
                array("id"=>"UF_SPEND_TIME", "name"=>"Время", "default"=>true)
            ),
            "SORT"=>$arResult["SORT"],
