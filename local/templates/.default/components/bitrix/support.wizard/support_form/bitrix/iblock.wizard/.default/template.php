...
<tr>
	...
	<td background="<?=$templateFolder?>/images/top_fill.gif" style="background-repeat: repeat-x" align=center valign=middle width=60>
	<img src="<?=$templateFolder?>/images/icon2.gif"><br><img src="/bitrix/images/1.gif" height=1 width=60></td>
