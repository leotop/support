...
?>
	...
	?>
<p>
<a href="http://support.webgk.ru/registr/<?//=$arResult["AUTH_REGISTER_URL"]?>"><b><?=GetMessage("AUTH_REGISTER")?></b></a><br />
<?=GetMessage("AUTH_FIRST_ONE")?> <a href="http://support.webgk.ru/registr/<?//=$arResult["AUTH_REGISTER_URL"]?>"><?=GetMessage("AUTH_REG_FORM")?></a>
</p>
	<?
	}
	?>
