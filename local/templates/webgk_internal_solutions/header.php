...
<head>
    ...
    <meta name="description" content="Готовые решения">
...
<div class="solution_poppup">
    <h1><?$APPLICATION->ShowTitle(false);?></h1>
    <div id="exit_solut">
        <a href="#"><img src="/i/exit_sol.png">
        </a>
    </div>


    <div class="slider_solution">

        <div class="solution_block1" id="solution_slider">  
    ...
    <div class="slider_solut_bottom">

        <div class="slider_solut_next" onclick="slider_solut('next')">
        </div>
        <div class="slider_solut_event" onclick="slider_solut('prev')">
        </div>
    ...
    <div class="solution_poppup_footer"><span><?$APPLICATION->IncludeFile(SITE_DIR."/include/phone.php",Array(),Array("MODE"=>"html"));?></span> &mdash; если вы не увидели подходящий вариант, звоните, он уже наверняка есть.</div>
...
<div class="internal_tabs">

<h1 id="tittle_solution" class="internal_h1"><?$APPLICATION->ShowTitle(false);?></h1>
<div class="tab_blocks">
<div class="left_blocks_resh">
<div class="tab_price">
    <?$APPLICATION->IncludeFile(SITE_DIR."/include/solutions/price.php",Array(),Array("MODE"=>"html"));?>
    </div>
