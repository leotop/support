...
<div class="scroll-pane" id="about_content"> 
...
<div class="job_poppup">
    <div id="exit_job"><a href="#"><img src="/i/exit_sol.png"></a></div>

    <div class="slider_job">     
        <div></div>

        <div class="job_poppup_footer"><span>HR@WEBGK.RU</span> &mdash; Нет подходящей вакансии? Но уверены, что могли бы стать ценным сотрудником для нашей компании? Срочно пишите нам!</div>  
    </div>           
</div>  
